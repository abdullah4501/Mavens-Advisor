  ...
  const features = [
    {
      ...
      title: 'Fixed Subscriptions',
      description: 'Transparent monthly pricing based on business activity. No surprises, no hidden hourly billing fees.'
    },
    {
      ...
      title: 'Complete Team',
      description: 'Dedicated CFO with full virtual finance department. End-to-end ownership, not outsourcing.'
    },
    {
      ...
      title: 'AI Analytics',
      description: 'Real-time performance visibility with actionable insights. Suggests tax savings and compliance strategies.'
    },
    {
      ...
      title: 'Evergreen Solution',
      description: 'Built to scale with your business. No rehiring, no transitions, growing together.'
    },
    {
      ...
      description: 'CFO-level leadership with complete financial control. Bookkeeping plus strategic guidance always.'
    },
  ];
          ...
          <div className='lg:col-span-2 col-span-1'>
            <div className='service-right'>
              ...
              >
                ...
                <AnimatedHeading
                  text="Why choose us as your virtual finance department?"
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-8 mb-16">
                ...
                >
                  <h3 className="text-[24px] font-semibold text-white mb-5 transition-colors duration-300">
                    Explore all our finance services
                  </h3>
                  <Link to={'/services'}
