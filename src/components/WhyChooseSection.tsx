...
import { TrendingUp, PieChart, Shield, Users, Award, Target } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Strategic planning for sustainable expansion'
    },
    {
      ...
      description: 'Expert guidance in investment decisions'
    },
    {
    ...
    },
    {
      ...
      description: 'Maintain excellence standards'
    },
  ];
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    className="group bg-gray-light p-8 rounded-2xl transition-all duration-500 card-hover cursor-pointer"
                  >
                    <div className="w-14 h-14 flex items-center justify-center mb-6 transition-colors duration-300">
                     {feature.svg}
                    </div>
                    <h3 className="text-xl font-semibold text-navy  mb-3 transition-colors duration-300">
                      {feature.title}
                    </h3>
