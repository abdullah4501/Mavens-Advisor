...
const services = [
    {
        ...
        description: "Clean, closed monthly books you can actually rely on—on time, every time.",
    },
    {
        image: img2,
        ...
        description: "Payroll run smoothly. Contractors paid correctly. No last-minute stress.",
    },
    {
        image: img3,
        ...
        title: "Invoicing, Billing, Payables & Receivables",
        description: "Get paid faster, stay on top of bills, and protect cash flow month to month.",
    },
];
