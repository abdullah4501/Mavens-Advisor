        ...
        <div className="flex flex-col h-full min-h-[500px] md:min-h-[600px]">
            ...
            <div className="flex-1 flex flex-col justify-end pb-4">
                {data.top.type === 'text' && (
                    <div className="text-center px-2">
                        <span className="text-gold font-semibold text-base md:text-[18px] tracking-wider mb-2 md:mb-3 block">
                            {data.top.year}
                        </span>
            ...
            <div className="flex-1 flex flex-col justify-start pt-4">
                {data.bottom.type === 'text' && (
                    <div className="text-center px-2">
                        <span className="text-gold font-semibold text-base md:text-[18px] tracking-wider mb-2 md:mb-3 block mt-2 md:mt-4">
                            {data.bottom.year}
                        </span>
                        <h3 className="text-white font-bold text-lg md:text-[24px] mb-2 md:mb-3 leading-tight">
                            {data.bottom.title}
...
const HistorySlider = () => {
    return (
        <section className="relative min-h-[80vh] bg-navy py-12 md:py-20 overflow-hidden">
            <div className="">
                <div className="flex flex-col items-center max-w-3xl mx-auto mb-10 md:mb-16">
                    <span className="inline-block bg-gold text-white font-semibold px-4 py-1.5 text-xs uppercase rounded mb-6">
                        Our History
                    </span>
                    <AnimatedHeading
