      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <div className="space-y-6">
            ...
            <div>
              <label className={`block text-sm font-medium mb-2 transition-colors ${errors?.country ? 'text-destructive' : 'text-foreground'}`}>
              ...
              <div className="relative">
                ...
                >
                  <SelectTrigger
                    className={`h-14 pl-12 pr-4 text-base rounded-xl border-2 transition-colors ${errors?.country ? 'border-destructive focus:border-destructive shadow-[0_0_15px_-5px_hsl(var(--destructive))]' : 'border-border focus:border-gold'}`}
                  >
