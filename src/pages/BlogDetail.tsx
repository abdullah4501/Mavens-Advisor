...
import BlogArticle from "@/components/blog/BlogArticvle";
import BlogSidebar from "@/components/blog/BlogSidebar";

const BlogDetail = ({ breadcrumb }) => {
        ...
        <>
            ...
            <section className="container section-padding">
                <div className="grid grid-cols-12">
                    <div className="col-span-12 lg:col-span-8 2xl:col-span-7 2xl:pr-4 min-w-0 article-detail">
                        <BlogArticle />
                    </div>

                    <div className="col-span-12 lg:col-span-4 2xl:col-span-4 2xl:col-start-9 lg:ml-16">
                        <BlogSidebar />
                    </div>
                </div>
